...
// папки
$docpath = Yii::app()->baseUrl . DIRECTORY_SEPARATOR . 'document' . DIRECTORY_SEPARATOR . 'result' . DIRECTORY_SEPARATOR;

if ($competition->tosserstatus == Weightcategory::TOSSER_NEW) {
    Yii::app()->user->setFlash('info', Yii::t('fullnames', 'Содержимое страницы будет обновлено позже'));
...
<?php
    ...
    if (Yii::app()->user->isExtendRole()) {
        echo CHtml::tag('a', array(
            'href'=>Yii::app()->createUrl('/competition/resultupdate'),
