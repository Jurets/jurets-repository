...
/*$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    ...
    if (empty($model->UserID)) {
        ...
        echo CHtml::tag('p', array('class'=>'help-block'), $help_str);
        //поле пароля
        echo $form->passwordFieldRow($model,'new_password', array('maxlength'=>50, 'class' => 'span2'));
        //вывести пояснение к полю пароля
        echo CHtml::tag('p', array('class'=>'help-block'), 'Введите свой <span class="required">пароль</span>: не менее четырёх символов, разрешены латинские буквы и цифры. Если оставить это поле пустым - пароль будет сгенерирован автоматически');
    ...
    echo CHtml::tag('p', array('class'=>'help-block'), 'Здесь Вы можете ввести любую дополнительную информацию о себе');
